...
whois = [
  ...
  "<br>",
  "- Raja specializes in conducting penetration testing for web applications, network applications, and mobile applications (Android and iOS)",
  "<br>",
  "- His area of expertise includes Docker containerization and creating Docker images for Pentesters",
  "<br>",
...
help = [
  ...
  '<span class="command">video</span>          My Youtube Channle',
